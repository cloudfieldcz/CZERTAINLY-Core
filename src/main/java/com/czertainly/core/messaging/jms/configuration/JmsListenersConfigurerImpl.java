...
import com.czertainly.core.messaging.proxy.ProxyResponseJmsEndpointConfig;
...
public class JmsListenersConfigurerImpl implements JmsListenerConfigurer {
    ...
    private final ProxyResponseJmsEndpointConfig proxyResponseJmsEndpointConfig;
    ...
    public void configureJmsListeners(JmsListenerEndpointRegistrar registrar) {
        ...
        registrar.registerEndpoint(proxyResponseJmsEndpointConfig.listenerEndpoint());
    }
}
